		...
		while (anzahlDerZuege > 0) {
			...
			if (antwort.equals("JA")) {
				...
				do {
					...
					//ï¿½berprï¿½fung, ob der Zug mï¿½glich ist
					if (spielfeld.pruefeBewegung(k1)) {
						isZugMoeglich = true;
						spielfeld.bewegeFigur(k1);
					} else {
						System.err.println("Zug nicht mï¿½glich");
					}
				} while (!isZugMoeglich);
...
//			}
	...
	/**
	 * Fuehrt die Angriffsphase fÃ¼r jeweils beide Spieler nacheinander aus.
